          ...
          <div class="row align-items-center">
              <div class="col-sm-6">
                  <div class="text-sm-left">
                      <p class="mb-0">2022 © Vim Holdings</p>
                  </div>
              </div>
              <!--end col-->
              ...
              <div class="col-sm-6">
                  <ul class="list-unstyled text-sm-right social-icon social mb-0 mt-4 mt-sm-0">
                      ...
                      <li class="list-inline-item"><a href="#"><i class="mdi mdi-git"></i></a></li>
                      <li class="list-inline-item"><a href="#"><i class="mdi mdi-medium"></i></a></li>
                  </ul>
              </div>
              <!--end col-->
          </div>
